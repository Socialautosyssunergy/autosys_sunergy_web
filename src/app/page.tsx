...
import { generateStructuredData } from '@/utils/seoOptimizer';
...
const FAQ = dynamic(() => import('@/components/home/FAQ'), {
  ssr: true,
  loading: () => <div className="animate-pulse bg-gray-200 h-32 rounded-lg flex items-center justify-center">
    <span className="text-gray-500">Loading FAQ...</span>
  </div>
});

// Dynamic import for contact form to reduce initial bundle
...
export default function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>Best Solar Panel Installation Company in Indore, MP | Autosys Sunergy</title>
        <meta name="description" content="Autosys Sunergy is the leading solar panel installation company in Indore, MP. We offer residential, commercial, and industrial solar solutions with 18+ years of experience." />
        {/* FAQ Schema */}
        <script
        ...
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: generateStructuredData('Service', serviceData)
          }}
        />
